	...
	<div style="width: 100%; height: 1600px; margin: 5% 0;">
		<div style="width: 100%; height: 100%; max-width: 1500px; min-width: 1500px; margin: 0 auto;">
			...
			<div class="acodian_menu_list"
				...
				<dl>
					<dt class="side_menu">
						<span class="span_menu">밥 종류</span> <img class="img_btn" src="resources/img/myOwn/plus.jpg" />
					</dt>
					<dd class="side_tedo">
						<div class="viewport">
							<ul class="rices_ul">
					...
					<dt class="side_menu">
						<span class="span_menu">메인 반찬</span><img class="img_btn" src="resources/img/myOwn/plus.jpg" />
					</dt>
					<dd class="side_tedo">
						<div class="viewport">
							<ul class="main_ul">
					...
					<dt class="side_menu">
						<span class="span_menu">서브 반찬1</span><img class="img_btn" src="resources/img/myOwn/plus.jpg" />
					</dt>
					<dd class="side_tedo">
						<div class="viewport">
							<ul class="sub1_ul">
								<%-- <% for(int i=0; i<sub1List.size();i++){ %>
									<li class="sub1s_li"><img id="sub1<%=i %>" class="sub1s" draggable="true" ondragstart="drag(event)" src="${pageContext.request.contextPath }/<%=sub1List.get(i).getImgRealPath() %>"/></li>
								<% } %> --%>
							</ul>
						</div>
						<br clear="all">
					...
					<dt class="side_menu">
						<span class="span_menu">서브 반찬2</span><img class="img_btn" src="resources/img/myOwn/plus.jpg" />
					</dt>
					<dd class="side_tedo">
						<div class="viewport">
							<ul class="sub2_ul">
								<%-- <% for(int i=0; i<sub2List.size();i++){ %>
									<li class="sub2s_li"><img id="sub2<%=i %>" class="sub2s" draggable="true" ondragstart="drag(event)" src="${pageContext.request.contextPath }/<%=sub2List.get(i).getImgRealPath() %>"/></li>
								<% } %> --%>
							</ul>
						</div>
						<br clear="all">
