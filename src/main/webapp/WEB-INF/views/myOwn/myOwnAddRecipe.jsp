		...
		<form action="recipeInsert.do" method="post">
			<div class="addRecipe">
				<div class="input-group mb-3" style="width: 40%; margin-left: auto; margin-right: auto;">
					...
					<input type="text" id="racipeName" name="racipeName" class="form-control" placeholder="나만의 도시락의 제목을 적어주세요." aria-label="Username" aria-describedby="basic-addon1">
				</div>
				<br clear="all">
				<div class="imgArea">
				...
				<div class="buttons">
					<input class="myOwnInsertBtn" type="submit" onclick="return validate();" value="나만의 도시락 추가" style="width: 180px; height: 50px;" />
