						...
						<table width=810>
							...
							<tr>
								<td align=center><textarea name="tos" rows=15 cols=100
										readonly>
제 1 조 (목적)		
 이 약관은 옥동도시락 주식회사가 제공하는 옥동도시락 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 옥동도시락 관련 제반 서비스를 의미합니다.						
...
⑦"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.
							...
							<tr>
								<td align=center><textarea name="tos" rows=15 cols=100
										readonly>
1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 직거래 블로그 등 대부분의 옥동도시락 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 옥동도시락은 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

회원가입 시점에 옥동도시락이 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
2. 수집한 개인정보의 이용
옥동도시락는 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.
