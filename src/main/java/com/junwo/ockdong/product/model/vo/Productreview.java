...
public class Productreview {
	...
	private Date pv_createDate; // 생성 날짜
	...
	public Date getPv_createDate() {
		return pv_createDate;
	}
	public void setPv_createDate(Date pv_createDate) {
	...
	public Productreview(int pv_Id, int p_Id, String pv_user, String pv_reviewContent, Date pv_createDate,
